...
export interface ITaskService {
    ...
    addTaskForSprint(sprint_id: number, createTaskDTO: CreateTaskDTO, user_id: number): Promise<Result<Task>>;
    ...
    updateTaskStatus(task_id: number, updateStatusDTO: UpdateTaskStatusDTO, user_id: number): Promise<Result<Task>>
}
