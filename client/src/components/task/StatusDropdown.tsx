...
import { StatusDropdownProps } from "../../types/props";
          ...
          <div className="absolute left-0 mt-2 w-40 z-[70] bg-slate-900 border border-white/10 rounded-xl shadow-2xl p-1.5 backdrop-blur-xl">
            {statuses.map((s) => (
              <button
                ...
                className={`w-full flex items-center p-1 rounded-lg transition-colors ${
                  s === currentStatus ? "bg-white/10" : "hover:bg-white/5"
                }`}
              >
